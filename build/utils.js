...
var _exportNames = {
  bottom: true,
  cloneLayout: true,
  cloneLayoutItem: true,
  childrenEqual: true,
  fastRGLPropsEqual: true,
  fastPositionEqual: true,
  collides: true,
  compact: true,
  compactItem: true,
  correctBounds: true,
  getLayoutItem: true,
  getLayoutItemIndex: true,
  getFirstCollision: true,
  getAllCollisions: true,
  getStatics: true,
  moveElement: true,
  moveElementAwayFromCollision: true,
  perc: true,
  setTransform: true,
  setTopLeft: true,
  sortLayoutItems: true,
  sortLayoutItemsByRowCol: true,
  sortLayoutItemsByColRow: true,
  synchronizeLayoutWithChildren: true,
  validateLayout: true,
  compactType: true,
  autoBindHandlers: true,
  noop: true
};
...
Object.keys(_calculateUtils).forEach(function(key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _calculateUtils[key];
    }
  });
});
