      ...
      [
        {
          ...
          value: function componentDidMount() {
            ...
            this.props.dragApiRef.current = {
              dragIn: function dragIn(_ref2) {
                var layoutItem = _ref2.layoutItem,
                  node = _ref2.node,
                  event = _ref2.event,
                ...
                var _this2$props = _this2.props,
                  ...
                  containerPadding = _this2$props.containerPadding;

                var _calcXY = (0, _calculateUtils.calcXY)(
                    {
                ...
                if (!_this2.state.activeDrag) {
                  var l = _objectSpread({}, layoutItem, {
                    x: x,
                    y: y
                  });
                  ...
                  _this2.setState({
                    oldDragItem: l,
                    oldLayout: layout,
                    layout: [].concat(_toConsumableArray(_this2.state.layout), [
                      l
                    ]),
                    activeDrag: l
                  });
                  ...
                  _this2.onDrag(layoutItem.i, x, y, {
                    e: event,
                    node: node,
              ...
              dragOut: function dragOut() {
                if (dragInfo) {
                  var _dragInfo = dragInfo,
                    layoutItem = _dragInfo.layoutItem;

                  _this2.setState(function(state, props) {
                    return {
                      layout: (0, _utils.compact)(
                        state.layout.filter(function(d) {
                          return d.i !== layoutItem.i;
                        }),
                        (0, _utils.compactType)(_this2.props),
                        props.cols
                      ),
                      activeDrag: null
                    };
              ...
              stop: function stop(_ref3) {
                ...
                if (dragInfo) {
                  var _dragInfo2 = dragInfo,
                    layoutItem = _dragInfo2.layoutItem,
                    node = _dragInfo2.node;
                  var w = layoutItem.w,
                    h = layoutItem.h;
                  var _this2$props2 = _this2.props,
                    margin = _this2$props2.margin,
                    containerPadding = _this2$props2.containerPadding;
                  ...
                  _this2.onDragStop(layoutItem.i, x, y, {
                    e: event,
                    node: node,
                    newPosition: position
                  });
        ...
        },
        {
          ...
          value: function onDragStop(
            ...
            this.currentContainerHeight = 0; // Set state
...
_defineProperty(ReactGridLayout, "defaultProps", {
  ...
  dragApiRef: _react.default.createRef(),
  droppingItem: {
    i: "__dropping-elem__",
    h: 1,
    w: 1
