    ...
    function(t, e, n) {
          ...
          return (
            a.default.Children.forEach(e, function(e, n) {
              ...
              if (o) i[n] = c(o);
                ...
                a
                  ? (s || D([a], "ReactGridLayout.children"),
                    (i[n] = c(r({}, a, { i: e.key }))))
      ...
      function y(t, e, n, r, o) {
        ...
        for (var i = void 0; (i = v(t, e)); )
          a ? h(o, e, i.x + i.w, "x") : h(o, e, i.y + i.h, "y"),
      ...
      function x(t, e, n, r, o, a, i, s) {
        ...
        for (var f = 0, d = p.length; f < d; f++) {
          ...
          j(
            ...
            h.moved ||
              (t = h.static ? S(t, h, e, o, i, s) : S(t, e, h, o, i, s));
        }
        return t;
      }
    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        (P["[object Float32Array]"] = P["[object Float64Array]"] = P[
          ...
          (P[u] = P[l] = P[D] = P[p] = P[j] = P[f] = P[d] = P[h] = P[g] = P[
            m
          ] = P[b] = P[x] = P[S] = P[R] = P["[object WeakMap]"] = !1);
        var E = "object" == typeof t && t && t.Object === Object && t,
          k = "object" == typeof self && self && self.Object === Object && self,
          T = E || k || Function("return this")(),
          M = e && !e.nodeType && e,
              ...
              : (function(t, e, n, r, o, s) {
                  ...
                  if (!(n & a)) {
                    var C = w && K.call(t, "__wrapped__"),
                      P = O && K.call(e, "__wrapped__");
                    if (C || P) {
                      var E = C ? t.value() : t,
                        k = P ? e.value() : e;
                      return s || (s = new jt()), o(E, k, n, r, s);
                    }
                  }
                  if (!z) return !1;
                  return (
        ...
        function Tt(t) {
          return (
            !(!$t(t) || ((e = t), Q && Q in e)) && (Gt(t) ? tt : z).test(qt(t))
          );
          var e;
        }
        function Mt(t) {
        ...
        function Lt(t, e, n, r, o, s) {
          ...
          for (s.set(t, e), s.set(e, t); ++f < l; ) {
            ...
            if (h) {
              if (
                !I(e, function(t, e) {
                  if (((a = e), !h.has(a) && (y === t || o(y, t, n, r, s))))
                    return h.push(e);
                  var a;
                })
              ) {
        ...
        var Kt = H
          ...
          : function(t) {
              return Jt(t) && Vt(t.length) && !!P[Pt(t)];
            };
        function Qt(t) {
          return null != (e = t) && Vt(e.length) && !Gt(e) ? zt(t) : Mt(t);
          var e;
        }
        ...
        d = (function(t) {
          ...
          return (
              ...
              (this.props.dragApiRef.value = {
                dragIn: function(n) {
                  ...
                  var u = o.w,
                    ...
                    y = (0, l.calcXY)(s.top, s.left, {
                      containerWidth: t.props.width,
                      cols: t.props.cols,
                      margin: d,
                      containerPadding: h || d,
                  ...
                  if (t.state.activeDrag)
                    t.onDrag(o.i, g, m, { e: i, node: a, newPosition: s });
                  else {
                    var v = r({}, o, { x: g, y: m });
                    t.setState({
                      oldDragItem: v,
                      oldLayout: p,
                      layout: [].concat(t.state.layout, [v]),
                      activeDrag: v
                    }),
                      t.props.onDragStart(p, v, v, null, i, a);
                  }
                },
                dragOut: function() {
                  if (e) {
                ...
                stop: function(n) {
                  ...
                  if (e) {
                    var a = e,
                      ...
                      p = t.props,
                      f = p.margin,
                      d = p.containerPadding,
                      h = (0, l.calcXY)(o.top, o.left, {
                        containerWidth: t.props.width,
                        cols: t.props.cols,
                        margin: f,
                        containerPadding: d || f,
                        rowHeight: t.props.rowHeight,
                        maxRows: t.props.maxRows,
                        w: u,
                        h: c
                      ...
                      y = h.x,
                      g = h.y;
                    t.onDragStop(i.i, y, g, { e: r, node: s, newPosition: o }),
                      (e = null);
                  }
                }
              }),
            ...
            (e.getDerivedStateFromProps = function(t, e) {
              ...
              return e.activeDrag
                ? null
                : ((0, i.default)(t.layout, e.propsLayout) &&
                  t.compactType === e.compactType
                    ? (0, u.childrenEqual)(t.children, e.children) ||
                      (n = e.layout)
                    : (n = t.layout),
                  n
                    ? {
              ...
              if (this.props.autoSize) {
                var t = (0, u.bottom)(this.state.layout),
                  ...
                  n =
                    ...
                    2 * e;
                return (
                  n > this.currentContainerHeight &&
                    (this.currentContainerHeight = n),
                  this.currentContainerHeight + "px"
                );
              }
            }),
            ...
            (e.prototype.onDrag = function(t, e, n, r) {
              ...
              if (c) {
                ...
                (s = (0, u.moveElement)(
                  ...
                  this.setState({
                    layout: (0, u.compact)(s, f(this.props), l),
                    activeDrag: p
                  });
              }
            }),
            (e.prototype.onDragStop = function(t, e, n, r) {
              var o = r.e,
                ...
                d = (0, u.getLayoutItem)(s, t);
              if (d) {
                (s = (0, u.moveElement)(s, d, e, n, !0, p, f(this.props), c)),
                  this.props.onDragStop(s, i, d, null, o, a),
                  (this.currentContainerHeight = 0);
                var h = (0, u.compact)(s, f(this.props), c),
                ...
                if (h) {
                  ...
                  if ((g = m.length > 0)) {
                    ...
                    m.forEach(function(t) {
                      t.x > y.x && (v = Math.min(v, t.x)),
                        t.y > y.y && (b = Math.min(b, t.y));
                    }),
                      Number.isFinite(v) && (y.w = v - y.x),
                      Number.isFinite(b) && (y.h = b - y.y);
                  }
                }
                g || ((y.w = e), (y.h = n));
                var w = { w: y.w, h: y.h, x: y.x, y: y.y, static: !0, i: t };
                this.props.onResize(l, c, y, w, a, i),
                  this.setState({
                    layout: (0, u.compact)(l, f(this.props), d),
                    activeDrag: w
                  });
              }
            }),
            (e.prototype.onResizeStop = function(t, e, n, r) {
              ...
              var d = (0, u.compact)(s, f(this.props), c),
            ...
            (e.prototype.processGridItem = function(t, e) {
              if (t && t.key) {
                var n = (0, u.getLayoutItem)(this.state.layout, String(t.key));
                if (!n) return null;
                var r = this.props,
                  a = r.width,
                  i = r.cols,
                  ...
                  v = this.state,
                  b = v.mounted,
                  w = v.droppingPosition,
                  x = Boolean(
                    !n.static && d && (n.isDraggable || null == n.isDraggable)
                  ),
                  S = Boolean(
                    !n.static && h && (n.isResizable || null == n.isResizable)
                  );
                return o.default.createElement(
                  c.default,
                  {
            ...
            (e.prototype.render = function() {
              var t = this,
                ...
                a = e.style,
                i = e.isDroppable,
                l = (0, s.default)("react-grid-layout", n),
                c = r({ height: this.containerHeight() }, a);
              return o.default.createElement(
                "div",
                {
                  className: l,
      ...
      var h = function() {
        ...
        (this.state = {
          ...
          (this.onDragOver = function(e) {
            var n = t.props.droppingItem,
              a = t.state.layout,
              i = e.nativeEvent,
              s = i.layerX,
              u = i.layerY,
              l = { x: s, y: u, e: e };
            if (t.state.droppingDOMNode) {
              if (t.state.droppingPosition) {
                (t.state.droppingPosition.x != s ||
                  t.state.droppingPosition.y != u) &&
                  t.setState({ droppingPosition: l });
              }
            } else
              t.setState({
                droppingDOMNode: o.default.createElement("div", { key: n.i }),
                droppingPosition: l,
                layout: [].concat(a, [
                  r({}, n, { x: 0, y: 0, static: !1, isDraggable: !0 })
                ])
              });
          ...
          (this.onDrop = function() {
            ...
            t.setState({
              ...
              t.props.onDrop({ x: i, y: s, w: l, h: c });
          });
      };
      e.default = d;
    },
...
*/
                ...
                oneOfType: function(t) {
                  ...
                  return c(function(e, n, r, o, a) {
                    for (var i = 0; i < t.length; i++) {
                      var s = t[i];
                      if (null == s(e, n, r, o, a, d)) return null;
                    }
                    return new l(
	...
	*/
        ...
        var C = (function() {
            ...
            if (t in e) return "";
            for (var n = 0; n < j.length; n++) if (z(t, j[n]) in e) return j[n];
            return "";
          })(),
          P = function(t, e) {
            if (!(t instanceof e))
                ...
                (o.handleDragStart = function(e) {
                  ...
                  if (
                    ...
                    if (null != i) {
                      ...
                      !1 !== c &&
                        (o.props.enableUserSelectHack && F(r),
              ...
              },
              {
                ...
                value: function() {
                  ...
                  var p = this.props,
                    ...
                    d = p.defaultClassNameDragging,
                    h = p.defaultClassNameDragged,
                    y = e.Children.only(this.props.children),
                    g = x(
                      y.props.className || "",
                      f,
                      (k((t = {}), d, this.state.dragging),
                      k(t, h, this.state.dragged),
                      t)
                    );
        ...
        return (
          ...
          (ot.defaultProps = T({}, rt.defaultProps, {
            axis: "both",
            bounds: !1,
    ...
    function(t, e, n) {
      ...
      var y = (function(t) {
          ...
          return (
            ...
            (r.onDragStart = function(t, e) {
              ...
              if (r.props.onDragStart) {
                ...
                if (a) {
                  ...
                  (o.left = s.left - i.left + a.scrollLeft),
                    (o.top = s.top - i.top + a.scrollTop),
                    r.setState({ dragging: o });
                  var u = h(o.top, o.left, r.props),
                    l = u.x,
                    c = u.y;
                  return (
                    r.props.onDragStart &&
                    r.props.onDragStart.call(r, r.props.i, l, c, {
                      e: t,
                      node: n,
                      newPosition: o
                    })
            ...
            (r.onDrag = function(t, e) {
              ...
              if (r.props.onDrag) {
                ...
                (i.left = r.state.dragging.left + o),
                  (i.top = r.state.dragging.top + a),
                  r.setState({ dragging: i });
                var s = h(i.top, i.left, r.props),
                  u = s.x,
                  l = s.y;
                return (
                  r.props.onDrag &&
                  r.props.onDrag.call(r, r.props.i, u, l, {
                    e: t,
                    node: n,
                    newPosition: i
                  })
            ...
            (r.onDragStop = function(t, e) {
              ...
              if (r.props.onDragStop) {
                ...
                var a = h(o.top, o.left, r.props),
                  i = a.x,
                  s = a.y;
                return (
                  r.props.onDragStop &&
                  r.props.onDragStop.call(r, r.props.i, i, s, {
                    e: t,
                    node: n,
                    newPosition: o
                  })
            ...
            (r.onResizeStop = function(t, e) {
              r.onResizeHandler(t, e, "onResizeStop");
            }),
            (r.onResizeStart = function(t, e) {
        ...
        return (
          ...
          (e.prototype.moveDroppingItem = function(t) {
            var e = this.props.droppingPosition,
              n = this.state.dragging;
            if (e && t.droppingPosition) {
              this.currentNode ||
                (this.currentNode = a.default.findDOMNode(this));
              var r =
                (n && e.x !== t.droppingPosition.x) ||
                e.y !== t.droppingPosition.y;
              if (n) {
                if (r) {
                  var o = e.x - n.left,
                    i = e.y - n.top;
          ...
          (e.prototype.createStyle = function(t) {
            ...
            return (
              e.useCSSTransforms
                ? (o = (0, l.setTransform)(t))
                : ((o = (0, l.setTopLeft)(t)),
                  n &&
                    ((o.left = (0, l.perc)(t.left / r)),
                    (o.width = (0, l.perc)(t.width / r)))),
              o
            );
          }),
          ...
          (e.prototype.mixinResizable = function(t, e) {
            var n = this.props,
              ...
              f = this.calcPosition(0, 0, i, s),
              d = this.calcPosition(0, 0, l, c),
              h = [f.width, f.height],
              y = [Math.min(d.width, p), Math.min(d.height, 1 / 0)];
            return o.default.createElement(
              u.Resizable,
              {
                width: e.width,
          ...
          (e.prototype.onResizeHandler = function(t, e, n) {
            var r = e.node,
              o = e.size,
              a = this.props[n];
            if (a) {
              ...
              (y = Math.min(y, s - u)),
                (y = Math.max(y, 1)),
                (y = Math.max(Math.min(y, c), p)),
                (g = Math.max(Math.min(g, f), d)),
                this.setState({ resizing: "onResizeStop" === n ? null : o }),
                a.call(this, l, y, g, { e: t, node: r, size: o });
            }
          }),
          (e.prototype.render = function() {
            var t = this.props,
      ...
      var f = function(t) {
        ...
        d = (function(t) {
          ...
          return (
            ...
            (e.getDerivedStateFromProps = function(t, e) {
              if (!(0, i.default)(t.layouts, e.layouts)) {
                var n = e.breakpoint,
                  r = e.cols;
                return {
            ...
            (e.prototype.componentDidUpdate = function(t) {
              (this.props.width == t.width &&
                ...
                (0, i.default)(this.props.breakpoints, t.breakpoints) &&
                (0, i.default)(this.props.cols, t.cols)) ||
